...
export const ProductPage = () => {
	...
	useEffect(() => {
		setMakeup(Category.Makeup_Category);
	}, []);

	useEffect(() => {
		setMakeupPr(Category.Makeup_Product_Type);
	}, []);

	useEffect(() => {
		setCFormat(Category.Complexion_Format);
	}, []);

	useEffect(() => {
		setCFinish(Category.Complexion_Finish);
	}, []);

	useEffect(() => {
		setCCoverage(Category.Complexion_Coverage);
	}, []);

	useEffect(() => {
		setCTA(Category.Cosmetics_TA);
	}, []);

	useEffect(() => {
		setCBT(Category.Cosmetics_BT);
	}, []);

	useEffect(() => {
		setLProducts(Category.Lips_Products);
	}, []);
	...
	useEffect(() => {
		setAReviews(Category.Average_Reviews);
	}, []);
